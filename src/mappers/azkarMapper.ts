...
const CATEGORY_ICON_MAP: Record<number, string> = {
  ...
  122: 'kaaba', // دعاء يوم عَرَفَة
  123: 'gift', // ما يفعل من أتاه أمر يسره
  124: 'stethoscope', // ما يقول من أحس وجعا في جسده
  125: 'eye', // دعاء من خشي أن يصيب شيئا بعينه
  ...
  133: 'cloud-sun', // أذكار الصباح والمساء
  ...
  147: 'bed', // ما يقول إذا وضع ثوبه
  148: 'surprise', // دعاء التعجب والأمر السار
};
